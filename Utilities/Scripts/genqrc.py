...
def main(argv):
    ...
    parser.add_argument(
        ...
        metavar="PATH",
        default="-",
        help="location to which to write the output .qrc file" " (default=stdout)",
    )
    ...
    qrc_content = [
        "<!DOCTYPE RCC>",
        "<!--",
        "  This file was automatically generated by %s %r" % (os.path.basename(__file__), args.resource_directories),
        "  See %s/%s for more information."
        % ("https://www.slicer.org/w/index.php", "Documentation/Nightly/Developers/Build_system/Qt_resource_files"),
        "-->",
        "",
        '<RCC version="1.0">',
        "",
