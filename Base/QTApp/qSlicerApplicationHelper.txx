...
// See details at https://issues.slicer.org/view.php?id=4252
  ...
  QStringList failedToBeInstantiatedModuleNames = ctk::qSetToQList(
        ctk::qListToQSet(moduleFactoryManager->registeredModuleNames()) - ctk::qListToQSet(moduleFactoryManager->instantiatedModuleNames()));
