...
#if QT_VERSION >= QT_VERSION_CHECK(6, 9, 0)
    disconnect(overwriteProxyNameCheckbox, &QCheckBox::checkStateChanged, this, &qSlicerSequencesModuleWidget::synchronizedSequenceNodeOverwriteProxyNameStateChanged);
#else
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 9, 0)
    connect(playbackCheckbox, &QCheckBox::checkStateChanged, this, &qSlicerSequencesModuleWidget::synchronizedSequenceNodePlaybackStateChanged);
    connect(overwriteProxyNameCheckbox, &QCheckBox::checkStateChanged, this, &qSlicerSequencesModuleWidget::synchronizedSequenceNodeOverwriteProxyNameStateChanged);
    connect(saveChangesCheckbox, &QCheckBox::checkStateChanged, this, &qSlicerSequencesModuleWidget::synchronizedSequenceNodeSaveChangesStateChanged);
    connect(recordingCheckbox, &QCheckBox::checkStateChanged, this, &qSlicerSequencesModuleWidget::synchronizedSequenceNodeRecordingStateChanged);
#else
