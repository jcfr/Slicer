...
bool qSlicerSceneReader::load(const qSlicerIO::IOProperties& properties)
{
  ...
  if (!success
    ...
    if (extensions != lastLoadedExtensions)
      ...
      QSet<QString> notInstalledExtensions = ctk::qListToQSet(lastLoadedExtensionsList).subtract(ctk::qListToQSet(extensionsList));
      if (!notInstalledExtensions.isEmpty())
        ...
        QString extensionsInformation =
          ...
          .arg(ctk::qSetToQList(notInstalledExtensions).join(", "));
