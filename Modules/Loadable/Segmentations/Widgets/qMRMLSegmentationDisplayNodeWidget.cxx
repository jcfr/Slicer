...
void qMRMLSegmentationDisplayNodeWidgetPrivate::init()
{
  ...
  QObject::connect(this->checkBox_Visible, &QCheckBox::checkStateChanged, q, &qMRMLSegmentationDisplayNodeWidget::onVisibilityChanged);
#else
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 9, 0)
  QObject::connect(this->checkBox_VisibilitySliceFill, &QCheckBox::checkStateChanged, q, &qMRMLSegmentationDisplayNodeWidget::onVisibilitySliceFillChanged);
  QObject::connect(this->checkBox_VisibilitySliceOutline, &QCheckBox::checkStateChanged, q, &qMRMLSegmentationDisplayNodeWidget::onVisibilitySliceOutlineChanged);
  QObject::connect(this->checkBox_Visibility3D, &QCheckBox::checkStateChanged, q, &qMRMLSegmentationDisplayNodeWidget::onVisibility3DChanged);
#else
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 9, 0)
  QObject::connect(this->checkBox_VisibilitySliceFill_SelectedSegment, &QCheckBox::checkStateChanged, q, &qMRMLSegmentationDisplayNodeWidget::onSegmentVisibilitySliceFillChanged);
  QObject::connect(
    this->checkBox_VisibilitySliceOutline_SelectedSegment, &QCheckBox::checkStateChanged, q, &qMRMLSegmentationDisplayNodeWidget::onSegmentVisibilitySliceOutlineChanged);
  QObject::connect(this->checkBox_Visibility3D_SelectedSegment, &QCheckBox::checkStateChanged, q, &qMRMLSegmentationDisplayNodeWidget::onSegmentVisibility3DChanged);
#else
